...
confirmPassword.addEventListener("input", () => {
  ...
  if (
    ...
    !validatePasswordMatch(signupPassword.value, confirmPassword.value)
  ) {
...
signupFormElement.addEventListener("submit", (e) => {
  ...
  if (!password) {
    ...
    if (!valid) {
      showError("signupPasswordError", message);
      hasErrors = true;
    }
  }
  ...
  if (!confirmPass) {
    ...
    hasErrors = true;
  } else if (!validatePasswordMatch(password, confirmPass)) {
    showError("confirmPasswordError", "Passwords do not match");
    hasErrors = true;
  }
